...
public class DataStructuresAlgorithms {
  ...
  // Not efficient
  public static void findNumber(int[] arrayOfNumbers, int myNumber) {
  ...
  // Nested arrays
  public static void logAllPairsOfArray(int[] arrayOfNumbers) {
  ...
  // Nested arrays
  public static void sumAllPairsOfArray(int[] arrayOfNumbers) {
  ...
  public static boolean findEqualEntriesOnArray(String[] array1, String[] array2){
  ...
  public static boolean hasPairsWithSums(int[] ArrayOfNumbers, int sum) {
